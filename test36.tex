...
\newcommand{\hmmnode}{-}
\newcommand{\hmmcost}{-}
\newcommand{\hmmcollect}{7}
\newcommand{\hmmplace}{G}
\newcommand{\hmmtext}{%
	\α 〔全てのキャラクター〕は「変身」を持ち、このカードの変身状態を変身状態として持つ。
	
	\収集 〔全てのキャラクター〕は、決死状態になった場合収集される。
}
\newcommand{\hmmp}{-}
\newcommand{\hmmt}{-}
\newcommand{\hmfravor}{「は、オカルトボール?」}
\newcommand{\hmmcname}{オカルト強化}
\newcommand{\hmmcrace}{種族なし}
\newcommand{\hmmcspirit}{5}
\newcommand{\hmmcgraze}{5}
\newcommand{\hmmcp}{10}
\newcommand{\hmmct}{10}
\newcommand{\hmmctext}{%
	\γ 〔このキャラクター〕が戦闘を行った場合、戦闘終了時に決死状態になる。
}
