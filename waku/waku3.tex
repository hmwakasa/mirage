...
\newcommand{\hmmimg}{}
\newcommand{\hmmfullimg}{uni.pdf}
\newcommand{\hmmname}{宇佐見　菫子}
\newcommand{\hmmnamer}{うさみ すみれこ}
...
\newcommand{\hmmsprit}{}
\newcommand{\hmmgraze}{}
\newcommand{\hmmrangea}{a}
\newcommand{\hmmranget}{m}
\newcommand{\hmmrace}{人間}
\newcommand{\hmmplace}{H}
\newcommand{\hmmtext}{}
\newcommand{\hmmp}{4}
\newcommand{\hmmt}{3}
...
\begin{tikzpicture}[x=1mm,y=1mm]
	...
	\path(C1)--(C3)node[midway,font=\hmcfont\Huge]{\hmfukuro{\hmmcost}};
	% ノード
	...
	\path(N1)--(N3)node[midway,font=\hmcfont\Huge]{\hmfukuro{\hmmnode}};
	\ifhmgr
	% 霊力
