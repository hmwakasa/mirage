...
\newcommand{\hmmimg}{}
\newcommand{\hmmname}{「紅色の幻想郷」}
\newcommand{\hmmnamer}{あかいろのげんそうきょう}
\newcommand{\hmmtype}{SC}
\newcommand{\hmmnode}{5}
\newcommand{\hmmcost}{2}
\newcommand{\hmmspellist}{レミリア・スカーレット}
...
\newcommand{\hmmtext}{%
	...
	（自動α）〔「種族: 妖怪」または「種族: 吸血鬼」を持つあなたの場のキャラクター全て〕
	は「戦闘修正: +3/+3」を得る。
	
	（自動α）〔「種族: 人間」を持つ相手キャラクター全て〕は「戦闘修正: -3/-3」を得る。
}
\newcommand{\hmmp}{-}
\newcommand{\hmmt}{-}
\newcommand{\hmmflavor}{}
