...
\begin{tikzpicture}[x=1mm,y=1mm]
	...
	%% テキスト
	\path(B1)-|(B3*)node[
		midway,below right,outer sep=0,inner sep=1mm,text width=54mm,text justified,font=\small\sffamily]{
			\hmmtext
		};
	%% 戦闘力
	\path($(B1)-(7,0)$)|-(B3*)node
