...
\newcommand{\hmmimg}{}
\newcommand{\hmmname}{霊符「夢想封印」}
\newcommand{\hmmnamer}{むそうふういん}
\newcommand{\hmmtype}{SC}
\newcommand{\hmmnode}{3}
\newcommand{\hmmcost}{2}
\newcommand{\hmmspellist}{博麗霊夢}
\newcommand{\hmmrangea}{t}
\newcommand{\hmmranget}{m}
\newcommand{\hmmplace}{J}
\newcommand{\hmmtext}{
	目標の〔キャラクター 1 枚〕に 3 ダメージを与える。このターン終了時に、
	さらにそのキャラクターに 3 ダメージを与える。
}
\newcommand{\hmmp}{-}
\newcommand{\hmmt}{-}
\newcommand{\hmmflavor}{}
...
\begin{tikzpicture}[x=1mm,y=1mm]
	...
	\draw[path picture={\node at (path picture bounding box.center)
		{\includegraphics[height=88mm]{../../ill/\hmmback}};}](O1)-|(O3)-|cycle;
	\ifhmfill
	%% フルアート
	\draw[path picture={\node at (path picture bounding box.center)
	...
	\path(O3)node[above right,text width=10\zw,align=left,inner ysep=0,outer ysep=0]
		{\hmfukuro{\scriptsize\hmsfont{\©}上海アリス幻樂団\\[-1pt]{\©}さーくる⑨, 2020\\[-3pt]CC-BY-NC 4.0}};
