...
\begin{tikzpicture}[x=1mm,y=1mm]
	...
	\path(I3)|-(I1)node[pos=.75,below left,inner xsep=0,outer xsep=0,font=\hmsfont\fontsize{1.8mm}{0}\hmsfont]
		{\hmfukuro{\hmmnumtype~}};
	\path(I3)|-(I1)node[pos=.75,below right,inner xsep=0,outer xsep=0,font=\hmsfont\fontsize{1.8mm}{0}\hmsfont]
		{\hmfukuro{\hmmnum}};
